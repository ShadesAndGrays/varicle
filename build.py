...
def load_cache():
    """ Loads argument cache from cache field"""
...
def build_cmake(args):
    ...
    if args.examples:
        config_command.append("-DBUILD_EXAMPLES=1")
...
def main():
    ...
    _ = build_parser.add_argument("--examples",action="store_true",help="build with examples",default=False)
